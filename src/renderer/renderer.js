...
const I18N = {
  zh: {
    ...
    threadsTotal: "累计会话",
    threadsTotalHint: "Dial 已记录的历史会话汇总；源 session 删除后仍保留。活跃数和最近会话仍按当前数据源计算。",
    allLocalRecords: "已保存的历史记录",
    threadsActive: "活跃",
    tokensTotal: "总 token",
  ...
  en: {
    ...
    threadsTotalHint: "Historical session summaries captured by Dial are retained after source sessions are deleted. Active and recent sessions still reflect the current data source.",
    allLocalRecords: "Saved history",
